...
void loop() {
  sensor_read_value(Sensor_1_add, 15);
  parsing_val(Sensor_1_add);
  val_comparsion(Sensor_1_old_value, Sensor_1_new_value);
  delay(100);
  sensor_read_value(Sensor_2_add, 15);
  parsing_val(Sensor_2_add);
  val_comparsion(Sensor_2_old_value, Sensor_2_new_value);
  delay(100);
  sensor_read_value(Sensor_3_add, 15);
  parsing_val(Sensor_3_add);
  val_comparsion(Sensor_3_old_value, Sensor_3_new_value);
  delay(100);
}
...
uint8_t val_comparsion(int Sensor_old_value, int Sensor_new_value)
{
